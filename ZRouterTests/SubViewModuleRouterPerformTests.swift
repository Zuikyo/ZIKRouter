...
class SubviewModuleRouterPerformTests: XCTestCase {
    ...
    func testPerformWithPrepareDestination() {
        ...
        enterTest()
        self.router = Router.perform(to: RoutableViewModule<BSubviewModuleInput>(), path: .makeDestination, configuring: { (config, prepareDestiantion, prepareModule) in
    ...
    func testPerformWithSuccessCompletionHandler() {
        ...
        enterTest()
        self.router = Router.perform(to: RoutableViewModule<BSubviewModuleInput>(), path: .makeDestination, configuring: { (config, prepareDestiantion, _) in
    ...
    func testPerformWithSuccess() {
        ...
        enterTest()
        self.router = Router.perform(to: RoutableViewModule<BSubviewModuleInput>(), path: .makeDestination, configuring: { (config, prepareDestination, prepareModule) in
            prepareModule({ module in
                module.title = "test title"
            })
