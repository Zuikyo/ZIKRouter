...
public class Registry {
    ...
    internal static var serviceProtocolContainer = [_RouteKey<Any>: DefaultServiceRouter.Type]()
    internal static var serviceConfigContainer = [_RouteKey<Any>: DefaultServiceRouter.Type]()
