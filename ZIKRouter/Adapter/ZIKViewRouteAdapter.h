...
/**
 Adapter for adapting provided protocol to required protocol. It's only for register protocols for other ZIKViewRouter, don't use it's instance. Subclass it and register protocols for other ZIKViewRouter in the subclass's +registerRoutableDestination with +registerViewProtocol: or +registerModuleProtocol:.
 @discussion
...
- (nullable instancetype)initWithStrictConfiguring:(void(NS_NOESCAPE ^)(ZIKViewRouteConfiguration *config,
