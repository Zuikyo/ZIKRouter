...
/**
 ...
 It's safe to use objc protocols inheriting from ZIKViewRoutable with ZIKRouterToView() and won't get nil. When ZIKROUTER_CHECK is enbled, ZIKViewRouter will validate all ZIKViewRoutable protocols when registration is finished, then we can make sure all routable view protocols have been registered with a router.
 */
