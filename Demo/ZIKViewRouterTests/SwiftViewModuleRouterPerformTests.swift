//
//  SwiftViewModuleRouterPerformTests.swift
//  ZIKViewRouterTests
//
...
class SwiftViewModuleRouterPerformTests: ZIKViewRouterTestCase {
    
    weak var testRouter: ModuleViewRouter<ASwiftViewModuleInput>? {
        willSet {
            self.router = newValue?.router
            self.strongTestRouter = newValue
        }
    }
    var strongTestRouter: ModuleViewRouter<ASwiftViewModuleInput>?
    ...
    func testPerformOnDestinationSuccess() {
        ...
        enterTest { (source) in
            let destination = Router.makeDestination(to: RoutableViewModule<ASwiftViewModuleInput>())
...
class SwiftViewModuleRouterPerformWithoutAnimationTests: SwiftViewModuleRouterPerformTests {
...
class SwiftViewModuleRouterPerformPresentAsPopoverTests: SwiftViewModuleRouterPerformTests {
    override func setUp() {
        super.setUp()
...
class SwiftViewModuleRouterPerformPresentAsPopoverWithoutAnimationTests: SwiftViewModuleRouterPerformPresentAsPopoverTests {
    override func setUp() {
        super.setUp()
        self.routeType = .presentAsPopover
    }
...
class SwiftViewModuleRouterPerformPushTests: SwiftViewModuleRouterPerformTests {
    override func setUp() {
        super.setUp()
        self.routeType = .push
    }
...
class SwiftViewModuleRouterPerformPushWithoutAnimationTests: SwiftViewModuleRouterPerformWithoutAnimationTests {
    override func setUp() {
        super.setUp()
        self.routeType = .push
    }
...
class SwiftViewModuleRouterPerformShowTests: SwiftViewModuleRouterPerformTests {
    override func setUp() {
        super.setUp()
        self.routeType = .show
    }
...
class SwiftViewModuleRouterPerformShowWithoutAnimationTests: SwiftViewModuleRouterPerformWithoutAnimationTests {
    override func setUp() {
        super.setUp()
        self.routeType = .show
    }
...
class SwiftViewModuleRouterPerformShowDetailTests: SwiftViewModuleRouterPerformTests {
    override func setUp() {
        super.setUp()
...
class SwiftViewModuleRouterPerformShowDetailWithoutAnimationTests: SwiftViewModuleRouterPerformWithoutAnimationTests {
    override func setUp() {
        super.setUp()
        self.routeType = .showDetail
    }
...
class SwiftViewModuleRouterPerformCustomTests: SwiftViewModuleRouterPerformTests {
    override func setUp() {
        super.setUp()
