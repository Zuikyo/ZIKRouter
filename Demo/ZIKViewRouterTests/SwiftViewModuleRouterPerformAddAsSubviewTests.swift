//
//  SwiftViewModuleRouterPerformAddAsSubviewTests.swift
//  ZIKViewRouterTests
//
...
class SwiftViewModuleRouterPerformAddAsSubviewTests: ZIKViewRouterTestCase {
    
    weak var testRouter: ModuleViewRouter<BSwiftSubviewModuleInput>? {
        willSet {
            self.router = newValue?.router
            self.strongTestRouter = newValue
        }
    }
    var strongTestRouter: ModuleViewRouter<BSwiftSubviewModuleInput>?
    ...
    func testPerformWithPrepareDestination() {
        ...
        enterTest { (source) in
            self.testRouter = Router.perform(
                to: RoutableViewModule<BSwiftSubviewModuleInput>(),
    ...
    func testPerformOnDestinationSuccess() {
        ...
        enterTest { (source) in
            let destination = Router.makeDestination(to: RoutableViewModule<BSwiftSubviewModuleInput>())
